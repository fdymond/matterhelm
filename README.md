...
dotnet test app/MatterHelm.Tests/MatterHelm.Tests.csproj -c Release   # 626 tests
...
**v0.4.3 released** (DDC/CI display power — no more Modern-Standby sleep on "displays off" — single-pill overlay, mDNS adapter dropdown; v0.4.2 before it: Windows mDNS discovery fix — the bridge now answers
...
994 automated tests across both processes, measured resource budgets
