...
public sealed class SidecarSupervisor : IDisposable
{
    ...
    private void StartChildLocked()
    {
        ...
        // The HTPC_BRIDGE_* prefix deliberately survives the S7-2 MatterHelm
        // rename: it is an internal contract between two components we own
        // both sides of, so renaming it carries churn/drift risk for zero
        // user-visible value.
